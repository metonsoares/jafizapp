...
`;function a(t,n,o){const e=window.open("","_blank","width=900,height=720");if(!e)return!1;const p=o!=null&&o.cor&&/^#[0-9a-fA-F]{6}$/.test(o.cor)?o.cor:"#12b57a",r=o!=null&&o.logoUrl?`<img src="${i(o.logoUrl)}" alt="" style="height:34px;max-width:180px;object-fit:contain;background:#fff;border-radius:6px;padding:2px 6px">`+(o.nome?`<span class="logo">${i(o.nome)}</span>`:"")+'<span class="sub">Feito com Já Fiz ✓<br>www.jafizapp.com.br</span>':'<span class="logo">Já Fiz ✓</span><span class="sub">Checklists que provam o trabalho feito<br>www.jafizapp.com.br</span>';return e.document.write(`<!doctype html><html lang="pt-BR"><head><meta charset="utf-8"><title>${i(t)}</title><style>${s}</style><style>.topo{background:${p}} h2{color:${p}} th{border-bottom-color:${p}}</style></head><body><div class="topo">${r}</div>`+n+"<script>window.onload = () => setTimeout(() => window.print(), 400);<\/script></body></html>"),e.document.close(),!0}export{a,i as e};
